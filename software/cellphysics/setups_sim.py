...
def gen_actions_sim(img):
    ...
    for key in points:
        ...
        for i in range(i_beg,i_end+1,interval_px):
            actions_res.append(points[key][i])
    return actions_res
...
def get_setups_tools_sim(names, idxes_train, idxes_test, idx_param):
    ...
    for obj in names:
        ...
        for i in idxes_train:
            action = {'finger':{'pos_px':  actions[i]['pos_px'],'yaw':0,
                                'velocity':actions[i]['velocity'], 
...
params = {  'book':[ {'masses':[0.29281076, 4.17102208]},
     ...
     'toothpaste': [ {'masses':[1.40235665, 3.13637913]},
                     {'masses':[1.22316457, 3.77436965]},
                     {'masses':[1.05198367, 3.80144197]},
                     {'masses':[1.12904118, 3.73160204]},
                     {'masses':[1.75582657, 3.01175136]},
                     {'masses':[1.77340558, 3.88665794]},
                     {'masses':[1.53924889, 3.0408778 ]},
                     {'masses':[1.18805848, 3.19007535]},
                     {'masses':[1.33816614, 3.95793507]},
                     {'masses':[1.6426988 , 3.24363832]} ],
